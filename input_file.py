...
in_spec = 'star1_vega_nm.dat' 		#Input science spectrum
in_spec2 = 'star1_vega_nm_w_exoplanet.dat' 		#Input science spectrum
...
bg_spec= 'zodiac.txt' 		# Background spectrum, i.e. zodiacal light
...
eta_in = 'QE2.txt', 'optics.txt'		# Spectral troughput of the entire system. Requires at minimum the CCD QE
...
disper = 'disp.npy' 		#Dispersion of the spectrograph
...
in_CCD = 'CCD.npy' 		# Input CCD imperfections. Sub-pixel variations
